...
描述:
    修改过的ald统计模块，不让其在文件加载时就初始化，改为放到window.aldInit初始化
    【目前已封装到AnalyzerAld，不要直接使用本文件接口】

初始化方法(目前已封装到AnalyzerAld，不要直接使用本模块)：
    window.aldInit(appkey, getLocation)，如
    window.aldInit('4f75fe52c6a5ac4c3c3319433688b2de', false)
*******************************************************************************/

if (cc.sys.platform === cc.sys.WECHAT_GAME && typeof(wx) != 'undefined') {
    let win = window;
    win.aldInit = 
    function(paramAppkey, paramGetLocation) {
        if(typeof(wx)=="undefined" || typeof(wx.request)=="undefined")
            return;
        function e() {
            function e(e) {
        ...
        var l = "2.0.0",
        h = "glog",
        g = {app_key: paramAppkey, getLocation: paramGetLocation};
